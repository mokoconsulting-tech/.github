...
NOTE: Synced to .github/copilot-instructions.md in all governed repositories via bulk sync.
      Tokens replaced at sync time: .github, https://github.com/mokoconsulting-tech/.github, PHP, Generic project
-->
...
> |---|---|
> | `.github` | The GitHub repository name (visible in the URL, `README.md` heading, or `git remote -v`) |
> | `https://github.com/mokoconsulting-tech/.github` | Full GitHub URL, e.g. `https://github.com/mokoconsulting-tech/<repo-name>` |
...
# .github — GitHub Copilot Custom Instructions
...
Repository URL: https://github.com/mokoconsulting-tech/.github
 ...
 *
 * FILE INFORMATION
 * DEFGROUP: .github.Module
 * INGROUP: .github
 * REPO: https://github.com/mokoconsulting-tech/.github
